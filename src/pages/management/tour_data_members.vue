<template>
  ...
  <div
    class="flex p-4 mb-4 text-sm text-yellow-600 rounded-lg bg-yellow-50 dark:bg-gray-800 dark:text-yellow-300"
    role="alert"
  >
    <svg
      aria-hidden="true"
      ...
      <div class="col-span-full xl:col-auto mb-4">
        ...
        <UiCard>
          <div class="flex justify-between">
            <h2 class="text-xl font-bold dark:text-white">ลูกทัวร์ : 2</h2>
            <div class="flex">
