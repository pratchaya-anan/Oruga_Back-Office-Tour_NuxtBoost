            ...
            <div class="col-span-3">
              <o-table :data="datamouth" class="col-span-3">
                ...
                <o-table-column field="date" label="หมายเหตุ" position="centered" v-slot:default="props">
                  {{ props.row.date }}
                  <NuxtLink href="/reportday"><Icon class="mr-5 w-6 h-6" name="tabler:zoom-in"></Icon></NuxtLink>
                  <NuxtLink href="/reportyear"><Icon class="w-6 h-6" name="tabler:zoom-out"></Icon></NuxtLink>
                </o-table-column>
              </o-table>
            </div>
            <div>
