<template>
  ...
  <o-steps variant="success">
    <o-step-item step="1" label="ข้อมูลทัวร์" :clickable="true" icon="user-lock">
      <!-- 1 ทัวร์ -->
      <section>
        <UiCard class="max-w-full">
          <div class="p-5">
            ...
            <div class="grid grid-cols-2 gap-4">
              ...
              <div>
                <o-field label="ชื่อโปรแกรม">
                  <o-input></o-input>
                </o-field>
              </div>
              <div>
                <o-field label="จำนวนวัน">
                  <o-input></o-input>
                </o-field>
              </div>
              <div>
                <o-field label="จำนวนคืน">
                  <o-input></o-input>
                </o-field>
              </div>
              <div>
                <o-field label="วันเริ่มต้น">
                  <o-input></o-input>
                </o-field>
              </div>
              <div>
                <o-field label="วันจบทริป">
                  <o-input></o-input>
                </o-field>
              </div>
              <div>
                <o-field label="ราคาต่อหน่วย">
                  <o-input></o-input>
                </o-field>
              </div>
              <div>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 xl:gap-4">
          <div class="col-span-full xl:col-auto mb-4">
            <UiCard>
                ...
                <div>
                  ...
                  <ol class="relative border-l border-gray-200 dark:border-gray-700">
                    <li class=" ml-4">
                      ...
                      <h2 class="mb-1 text-lg font-semibold text-gray-900 dark:text-white">นายสมชาย วดี</h2>
                      <p class="mb-1 text-base font-normal text-gray-500 dark:text-gray-400">เบอร์ติดต่อ </p>
                      <p class="text-base font-normal text-gray-900 dark:text-gray-400">092-868552 </p>
                      <p class="mb-1 text-base font-normal text-gray-500 dark:text-gray-400">ประเภทมัคคุเทศก์ </p>
                      <p class="mb-4 text-base font-normal text-gray-900 dark:text-gray-400">ทั่วไป/ภาคเหนือ</p>
                    </li>
                    <li class="mb-10 ml-4">
                      <div
                        class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -left-1.5 border border-white dark:border-gray-900 dark:bg-gray-700">
                      </div>
                      <h2 class="mb-1 text-lg font-semibold text-gray-900 dark:text-white">นาสาวมณี วันดี</h2>
                      <p class="mb-1 text-base font-normal text-gray-500 dark:text-gray-400">เบอร์ติดต่อ </p>
                      <p class="text-base font-normal text-gray-900 dark:text-gray-400">092-868552 </p>
                      <p class="mb-1 text-base font-normal text-gray-500 dark:text-gray-400">ประเภทมัคคุเทศก์ </p>
                      <p class="mb-4 text-base font-normal text-gray-900 dark:text-gray-400">ทั่วไป/ภาคเหนือ</p>
              ...
              <o-modal v-model:active="addhotel">
                <div class="grid grid-cols-2 gap-4 p-6">
                  <div class="col-span-2">
    ...
    <o-step-item step="3" label="ข้อมูลโรงแรม" :clickable="true" icon="user-plus">
      <!-- 3 โรงแรม -->
      <section class="h-m-screen">
        <div class="grid grid-cols-1 xl:grid-cols-3 xl:gap-4">
          <div class="col-span-full xl:col-auto mb-4">
    ...
    <o-step-item step="4" label="ข้อมูลพหนะ" :clickable="true" icon="user-plus">
      <!-- 4 พาหนะ -->
      <section class="h-m-screen">
        <div class="grid grid-cols-1 xl:grid-cols-3 xl:gap-4">
          <div class="col-span-full xl:col-auto mb-4">
