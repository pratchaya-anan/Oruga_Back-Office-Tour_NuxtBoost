                ...
                <div>
                  ...
                  >
                    <li class="ml-4">
                      ...
                      <p
                        class="mb-4 text-base font-normal text-gray-900 dark:text-gray-400"
                      >
                        ทั่วไป/ภาคเหนือ
                      </p>
                    </li>
            ...
            <UiCard>
              <div class="sm:flex xl:block sm:space-x-4 xl:space-x-0">
                <div>
                  ...
                  <h2 class="text-xl font-bold dark:text-white mt-3">พาหนะ</h2>
                  <ol
                    class="relative border-l border-gray-200 dark:border-gray-700"
                  >
                    <li class="ml-4">
                      ...
                      <p
                        class="mb-1 text-base font-normal text-gray-900 dark:text-gray-400"
                      >
                        2
                      </p>
                      <p
                      ...
                      <p
                        class="mb-2 text-base font-normal text-gray-900 dark:text-gray-400"
                      >
                        092-868552
                      </p>
                      <p
