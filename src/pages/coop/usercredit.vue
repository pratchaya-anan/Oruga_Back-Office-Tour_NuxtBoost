<template>
    <section>
        ...
        <div
            class="max-w-full mt-3 mt-3 p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="flex justify-end mt-2"><o-button>></o-button></div>
