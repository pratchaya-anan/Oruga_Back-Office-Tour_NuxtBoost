<template>
    <section>
        ...
        <div class="max-w-full p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <a href="#">
                <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">เงื่อนไข
                </h5>
            </a>
            ...
            <a class="ml-4 text-red-500">นายสมศรี สีสุข (หมายเหตุ เงินเดือนต่ำกว่า 20,000)</a>

        </ul>
        
    </div>
            <button type="button" class="ml-50 text-white bg-blue-400 dark:bg-blue-500 cursor-not-allowed font-medium rounded-lg text-sm px-5 py-2.5 text-center" disabled>ขอกู้</button>
