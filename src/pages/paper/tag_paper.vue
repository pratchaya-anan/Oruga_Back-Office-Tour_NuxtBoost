      ...
      <div class="flex flex-wrap justify-center">
        <div v-for="i in 10">
          <div class="border grid grid-flow-row text-center w-[10.3cm] h-[5cm]">
            ...
            <div
              class="bg-yellow-200 text-sm flex justify-center items-center h-6 -mb-10"
            >
              กาญจนบุรี-เพชรบุรี ระหว่างวันที่ 1/01-15/01/2566
            </div>
            <div class="grid grid-cols-10 text-pink-600 text-center h-full">
              <div
                class="flex flex-col justify-center items-center col-span-7 h-full"
              >
                <div class="texl-base font-semibold">SRIDARA TOUR</div>
              ...
              <div
                class="col-span-3 flex justify-center items-center font-bold text-4xl border-l h-full w-full"
              >
                {{ i }}
              </div>
            </div>
          </div>
          <div v-if="i % 10 == 0" id="pagebreak"></div>
        </div>
      </div>
    </div>
  </section>
