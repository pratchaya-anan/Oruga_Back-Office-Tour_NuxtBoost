    ...
    <div class="grid grid-cols-4 gap-2">
      ...
      <div>
        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          ...
          <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">รายรับ <span class="bg-green-100 text-green-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-green-900 dark:text-green-300">490093</span></p>
          <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">รายจ่าย <span class="bg-red-100 text-red-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-red-900 dark:text-red-300">385872</span></p>
          <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">กำไร/ขาดทุน <span class="bg-blue-100 text-blue-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300">104221</span></p>
        </div>
      </div>
    </div>
