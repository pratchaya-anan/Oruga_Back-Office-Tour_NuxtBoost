<template>
  <section>
    <LayoutPageTitle> Disbursement Estimate / รายการใบเบิกเงินสดย่อย </LayoutPageTitle>

    <UiManageBar>
      <NuxtLink to="/paper_create/disbursement_create" type="button"
...
const sec23 = Array.from(Array(4).keys()).map((x) => x + 1);
// console.log(sec23);

const tableDatatour = [
  {
    idpaper: "D230627-0001",
