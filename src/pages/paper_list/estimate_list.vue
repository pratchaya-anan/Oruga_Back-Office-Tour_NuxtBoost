<template>
  <section>
    ...
    <UiManageBar>
      <NuxtLink to="/paper_create/estimate_create" type="button"
    ...
    <section class="flex flex-wrap gap-4">
      <UiCard v-for="(it, idx) in sec23" :key="idx" @click="openmodal = true"
              ...
              <div>
                <div class="p-6 font-normal text-gray-700 dark:text-gray-400 mb-3">
                  ...
                  <diV>
                    ...
                    <div>
                      <Icon class="mr-3 -ml-1 w-5 h-5" name="fluent-emoji-high-contrast:department-store"></Icon>
                      การตลาด
                    </div>
                    <div>
                  ...
                  <div class="mt-5 flex justify-center">
                    <a href="/paper_create/estimate_create">
                      <o-button
