<template>
    <section>
        <LayoutPageTitle>Quotation/ใบเบิกค่าใช้จ่าย</LayoutPageTitle>

        <UiManageBar>
            <NuxtLink to="bill_payment" type="button"
