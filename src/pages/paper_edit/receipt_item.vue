<template>
  ...
  <div class="grid grid-cols-1 xl:grid-cols-3 xl:gap-4">
      ...
      <UiCard class="mb-4">
        ...
        >
          ...
          <o-field label="ที่อยู่">
            <o-input
              modelValue="175 ม.12 ต.บ้านเป็ด อ.เมืองขอนแก่น จ.ขอนแก่น 40000"
            ></o-input>
          </o-field>
          <section>
    ...
    <div class="col-span-2">
      ...
      <UiCard v-if="showItemsPanel" class="mb-4">
          ...
          <o-field label="วันที่">
            <div class="relative">
              ...
              <input
                datepicker
                type="text"
                class="flex gap-4 border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="Select date"
              />
            </div>
          </o-field>
          <o-field label="เลขที่ใบกำกับภาษี">
            <o-input></o-input>
          </o-field>
        </div>
        <div class="flex gap-4">
          <o-field class="flex-1" label="	รายละเอียด">
            <o-input></o-input>
          </o-field>
