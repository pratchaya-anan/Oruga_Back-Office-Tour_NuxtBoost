<template>
  <LayoutPageTitle> Cashreceipt / ใบสำคัญรับเงิน </LayoutPageTitle>
      ...
      <UiCard class="mb-4">
        ...
        <section v-if="showOrderPanel" class="my-4 border-t border-gray-200 dark:border-gray-700">
          ...
          <o-field label="ที่อยู่">
            <o-input modelValue="175 ม.12 ต.บ้านเป็ด อ.เมืองขอนแก่น จ.ขอนแก่น 40000"></o-input>
          </o-field>
          <o-field label="ได้รับเงินจาก (ผู้ซื้อ/ผู้รับบริการ)">
            <o-input modelValue="เทศบาลขอนแก่น ( นายภาคภูมิ ภูเขียว )"></o-input>
          </o-field>
          <section>
            ...
            <div class="sm:flex-1">
              <div class="text-sm not-italic font-normal text-gray-500 dark:text-gray-400">
                ...
                <div class="text-sm not-italic font-normal text-gray-500 dark:text-gray-400">
                  ...
                  <div class="mb-2 text-sm font-medium text-gray-900 dark:text-white">
                    เทศบาลขอนแก่น ( นายภาคภูมิ ภูเขียว )
                  </div>
                </div>
              </div>
            </div>
        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
          <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
            <tr>
              ...
              <th scope="col" class="px-6 py-3">จำนวนเงิน (บาท)</th>
          ...
          <tbody>
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              ...
              <td class="px-6 py-4">30/03/2566</td>
  ...
  <div class="flex justify-end">
    <a href="/paper/cashreceipt_paper">
      <o-button>
