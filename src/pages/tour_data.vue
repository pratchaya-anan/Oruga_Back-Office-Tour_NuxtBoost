            ...
            <div>
              ...
              <ul class="mt-2 space-y-1">
                ...
                <li class="flex items-center text-sm font-normal text-gray-500 dark:text-gray-400">
                  ...
                  19 คน
                  <Icon class="w-6 h-6 mr-1 ml-2" name="material-symbols:child-care"></Icon>
                  3 คน
                </li>
                <li class="flex items-center text-sm font-normal text-gray-500 dark:text-gray-400">
        ...
        <UiCard v-if="showItems == 'hotel'">
          ...
          <ol class="relative border-l border-gray-200 dark:border-gray-700">
            ...
            <li class="mb-10 ml-4">
              ...
              <time class="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">22 เมษายน 2566 - 23
                เมษายน 2566</time>
              <h3 class="flex justify-between text-lg font-semibold text-gray-900 dark:text-white">
            ...
            <li class="mb-10 ml-4">
              ...
              <time class="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">23 เมษายน 2566 - 24
                เมษายน 2566</time>
              <h3 class="flex justify-between text-lg font-semibold text-gray-900 dark:text-white">
                โรงแรม Century hotel
                <a href="#" @click="add = true" class="text-base font-normal text-gray-500 dark:text-gray-400">แก้ไข</a>
              </h3>
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                จำนวน 12 ห้อง
              </p>
        ...
        <UiCard v-if="showItems == 'vehicle'">
          ...
          <ol class="relative border-l border-gray-200 dark:border-gray-700">
            <li class="mb-10 ml-4">
              ...
              <h3 class="flex justify-between text-lg font-semibold text-gray-900 dark:text-white">
                รถบัสลาว
                <a href="#" @click="isItemModalHotelData4 = true"
                  class="text-base font-normal text-gray-500 dark:text-gray-400">แก้ไข</a>
              </h3>
        ...
        <UiCard v-if="showItems == 'checkpoin'">
          ...
          <ol class="relative border-l border-gray-200 dark:border-gray-700">
            <li class="mb-10 ml-4">
              ...
              <time class="text-sm font-normal leading-none text-gray-400 dark:text-gray-500">21 เมษายน 2566</time>
              <h3 class="flex justify-between text-lg font-semibold text-gray-900 dark:text-white">
                บ้านหนองผือ
                <a href="#" @click="isItemModalHotelData5 = true"
                  class="text-base font-normal text-gray-500 dark:text-gray-400">แก้ไข</a>
              </h3>
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
            ...
            <li class="mb-10 ml-4">
              ...
              <time class="text-sm font-normal leading-none text-gray-400 dark:text-gray-500">22 เมษายน 2566</time>
              <h3 class="mt-1 flex justify-between text-lg font-semibold text-gray-900 dark:text-white">
                <a>เว้-ตานัง</a><a href="#" class="text-base font-normal text-gray-500 dark:text-gray-400">แก้ไข</a>
              </h3>
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
            ...
            <li class="mb-10 ml-4">
              ...
              <time class="text-sm font-normal leading-none text-gray-400 dark:text-gray-500">23 เมษายน 2566</time>
              <h3 class="mt-1 flex justify-between text-lg font-semibold text-gray-900 dark:text-white">
                <a>บาน่าฮิว</a><a href="#" class="text-base font-normal text-gray-500 dark:text-gray-400">แก้ไข</a>
              </h3>
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
            ...
            <li class="mb-10 ml-4">
              ...
              <time class="text-sm font-normal leading-none text-gray-400 dark:text-gray-500">24 เมษายน 2566</time>
              <h3 class="mt-1 flex justify-between text-lg font-semibold text-gray-900 dark:text-white">
                <a>เว้</a><a href="#" class="text-base font-normal text-gray-500 dark:text-gray-400">แก้ไข</a>
              </h3>
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
          ...
          <ol class="relative border-l border-gray-200 dark:border-gray-700">
            <li class="mb-10 ml-4">
              ...
              <h3
                ...
                โครตอร่อย!
                <a href="#" @click="isItemModalHotelData6 = true"
                  class="text-base font-normal text-gray-500 dark:text-gray-400">แก้ไข</a>
              </h3>
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
            ...
            <li class="mb-10 ml-4">
              ...
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                18.00 น. ทานอาหารเทียง ร้านเลียจาน
              </p>
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                เบอร์ติดต่อ 0428976765
              </p>
            ...
            <li class="mb-10 ml-4">
              ...
              <h3
                class="mt-1 flex justify-between text-lg font-semibold text-gray-900 dark:text-white">
               ร้านอาหารอาโนะเนะ
                <a href="#" class="text-base font-normal text-gray-500 dark:text-gray-400">แก้ไข</a>
              </h3>
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
              ...
              <div class="mx-5">
                ...
                <div class="mb-2 grid grid-cols-4 gap-0">
                  ...
                  <p class="w-full text-end">
                    <Icon class="w-6 h-6" name="mdi:comment-edit" @click="
                      editcomment != true
                        ? (editcomment = true)
                        : (editcomment = false)
                      ">
          ...
          <UiCard>
            ...
            <div class="w-full">
              <div class="mt-5 flex justify-between">
                ...
                <o-button size="medium" variant="primary" @click="isItemModalHotelData3 = false">
                  บันทึก
                </o-button>
              </div>
            </div>
              ...
              <div class="w-full flex flex-col items-center">
                ...
                <div>
                  <span class="px-10 text-sm text-gray-500 dark:text-gray-400 truncate">
                    <Icon class="w-4 h-4 mr-1" name="majesticons:comment-text"></Icon>{{ item.comment }}
                  </span>
                </div>
              </div>
            </UiCard>
