    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 xl:gap-4">
      <div class="col-span-full xl:col-auto mb-4">
            ...
            <div>
              ...
              <ul class="mt-2 space-y-1">
                ...
                >
                  ...
                  ></Icon>
                  23 คน
                  <Icon class="w-6 h-6 mr-1 ml-6" name="el:person"></Icon>
                  19 คน
                  <Icon
                    class="w-6 h-6 mr-1 ml-2"
                    name="material-symbols:child-care"
                  ></Icon>
                  3 คน
                </li>
                <li
        ...
        <UiCard v-if="showItems == 'hotel'">
          ...
          <h2 class="text-xl font-bold dark:text-white">โรงแรม</h2>
          <ol class="relative border-l border-gray-200 dark:border-gray-700">
            <li class="mb-10 ml-4">
              ...
              <time
                ...
                >21 เมษายน 2566 - 22 เมษายน 2566</time
              >
              <h3
            ...
            <li class="mb-10 ml-4">
              ...
              <time
                class="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-gray-500"
                >22 เมษายน 2566 - 23 เมษายน 2566</time
              >
              <h3
                class="flex justify-between text-lg font-semibold text-gray-900 dark:text-white"
              >
                โรงแรม Mercure Bana hills
                <a
                  href="#"
                  @click="add = true"
                  class="mt-1 text-base font-normal text-gray-500 dark:text-gray-400"
            ...
            <li class="mb-10 ml-4">
              ...
              <time
                class="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-gray-500"
                >23 เมษายน 2566 - 24 เมษายน 2566</time
              >
              <h3
                class="flex justify-between text-lg font-semibold text-gray-900 dark:text-white"
              >
                โรงแรม Century hotel
                <a
                  href="#"
                  @click="add = true"
                  class="mt-1 text-base font-normal text-gray-500 dark:text-gray-400"
        ...
        <UiCard v-if="showItems == 'guide'">
          ...
          <h2 class="text-xl font-bold dark:text-white">ไกด์</h2>
            ...
            <dev class="w-full relative inline-flex items-center">
              ...
              <div class="ml-5 w-full">
                ...
                >
                  ...
                  <a
                    href="#"
                    @click="isItemModalHotelData3 = true"
        ...
        <UiCard v-if="showItems == 'vehicle'">
          ...
          <h2 class="mb-2 text-xl font-bold dark:text-white">ยานพาหนะ</h2>
          <ol class="relative border-l border-gray-200 dark:border-gray-700">
            <li class="mb-10 ml-4">
              <div
                class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -left-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"
              ...
              >
              <h3
                class="flex justify-between text-lg font-semibold text-gray-900 hover:text-gray-500 dark:text-white"
              >
                รถบัสลาว
                <a
                  href="#"
                  @click="isItemModalHotelData4 = true"
                  class="text-base font-normal text-gray-500 dark:text-gray-400"
                  >แก้ไข</a
                >
              </h3>
        ...
        <UiCard v-if="showItems == 'checkpoin'">
          ...
          <ol class="relative border-l border-gray-200 dark:border-gray-700">
            <li class="mb-10 ml-4">
              ...
              >
              <h3
                class="mt-1 flex justify-between text-lg font-semibold text-gray-900 dark:text-white"
              >
                <a>บ้านหนองผือ</a
                ><a
                  href="#"
                  @click="isItemModalHotelData5 = true"
                  class="text-base font-normal text-gray-500 dark:text-gray-400"
                  >แก้ไข</a
                >
              </h3>
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                05.00 น. อ.ชานุมาน อำนาจเจริญ ออกเดินทางไปยังด่าน
                ตม.มุกดาหารเพื่อเดินทางต่อไปยังด่านลาวบาว
              </p>
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                <Icon
                  class="w-6 h-6"
              ...
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                12.00 น.รับประทานอาหารเที่ยง หน้าด่านลาวบาว
                ระหว่างรอเอกสารข้านแดน จากนั้นเดินทางต่อไปยังเมือง เว้-ตานัง
              </p>
              <h3
                class="mt-1 flex justify-between text-lg font-semibold text-gray-900 dark:text-white"
              >
              ...
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                เย็น รับประทานอาหารเย็น / เที่ยวชมสะพานมังกร / สะพานแห่งความรัก
                / เข้าที่พัก
              </p>
            </li>
            <li class="mb-10 ml-4">
              ...
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                เช้า รับประทานอาหารเช้าที่โรงแรม / เดินทางไปเมืองฮอยอัน
              </p>
              <h3
                class="mt-1 flex justify-between text-lg font-semibold text-gray-900 dark:text-white"
              >
              ...
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                เที่ยง รับประทานอาหารเที่ยง / เดินทางขึ้นไปบาน่าฮิลล์
              </p>
              <h3
                class="mt-1 flex justify-between text-lg font-semibold text-gray-900 dark:text-white"
              >
              ...
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                บ่าย นั่งกระเช้าลอยฟ้า / สะพานเมืองทอง / สวนดอกไม้
              </p>
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
            ...
            <li class="mb-10 ml-4">
              ...
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                ...
                เดินทางลงจากบาน่าฮิลล์สู่เมืองเว้
              </p>
              <h3
                class="mt-1 flex justify-between text-lg font-semibold text-gray-900 dark:text-white"
              >
              ...
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                เที่ยง รับประทานอาหารเที่ยง / ชมพระราชวังได๋โหน๋ย / ตลาดดงบา /
            ...
            <li class="mb-10 ml-4">
              ...
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                เช้า รับประทานอาหารเช้าที่โรงแรม / เดินทางกลับประเทศไทย
              </p>
              <h3
                class="mt-1 flex justify-between text-lg font-semibold text-gray-900 dark:text-white"
              >
              ...
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                เทียง ทำพิธีการข้ามด่าน / รับประทานอาหารเที่ยง /
                เดินทางต่อมายังด่านสะหวันนะเขต
              </p>
              <h3
                class="mt-1 flex justify-between text-lg font-semibold text-gray-900 dark:text-white"
              >
          ...
          <div v-if="showComment">
            ...
            <div class="flex">
              ...
              <section class="flex-1 shrink flex items-center justify-end">
                <o-button @click="showComment = false" class="ml-4 mt-5"
                  >ปิด
                </o-button>
        ...
        <UiCard v-if="showItems == 'restaurant'">
          ...
          <h2 class="mb-2 text-xl font-bold dark:text-white">ร้านอาหาร</h2>
          <ol class="relative border-l border-gray-200 dark:border-gray-700">
            <li class="mb-10 ml-4">
              <div
                class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -left-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"
              ...
              >
                <a href="#">ร้านเลียจาน</a
                ><a
                  href="#"
                  @click="isItemModalHotelData6 = true"
                  class="text-base font-normal text-gray-500 dark:text-gray-400"
                  >แก้ไข</a
                >
              </h3>
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                12.00 น. ทานอาหารเทียง ร้านเลียจาน
              </p>
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                เบอร์ติดต่อ 0428976765
              </p>
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                <Icon
                  ...
                  "
                ></Icon>
                เป็นอาหารที่ดีที่สุดที่เคยทานมา
              </p>
            </li>
            <li class="mb-10 ml-4">
              <div
              ...
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                12.00 น. ทานอาหารเี่ยง ร้านอาหารอาโนะเนะ
              </p>
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                T. 0428976765
              </p>
              ...
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                18.00 น. ทานอาหารเย็น กินไหมจร๊ะ
              </p>
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                T. 0428976765
              </p>
            ...
            <li class="mb-10 ml-4">
              ...
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                12.00 น. ทานอาหารเที่ยง ร้านอาหาร อัลไล
              </p>
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                T. 0428976765
              </p>
              ...
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                18.00 น. ทานอาหารเย็น วงวารอาหาร
              </p>
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                T. 0428976765
              </p>
            ...
            <li class="mb-10 ml-4">
              ...
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                18.00 น. ทานอาหารเย็น โต๋วโภชนา
              </p>
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                T. 0428976765
              </p>
          ...
          <UiCard>
              ...
              <dev class="w-full relative inline-flex items-center">
                <div class="mx-5">
                  ...
                  <p
                    class="text-base font-normal text-gray-500 dark:text-gray-400"
                  >
                    ที่อยู่ Lot 2 - A2 - KH, Phạm Văn Đồng, Street, Sơn Trà, Đà
                    Nẵng 550000 เวียดนาม
                  </p>
                  <p
                    class="text-base font-normal text-gray-500 dark:text-gray-400"
                  >
              ...
              <div class="mx-5">
                ...
                <div class="mb-2 grid grid-cols-4 gap-0">
                  <div v-if="editcomment" class="col-span-2">
                    <o-input
                      type="text"
                      modelValue="เป็นโรงแรมที่ดีมาก"
                    ></o-input>
                  </div>
                  <p v-if="!editcomment" class="col-span-2">
                    เป็นโรงแรมที่ดีมาก
                  </p>
                  ...
                  <div v-if="editcomment2" class="col-span-2">
                    <o-input
                      type="text"
                      modelValue="ปรับปรุงครั้งล่าสุดดีขึ้นแล้ว"
                    ></o-input>
                  </div>
                  <p v-if="!editcomment2" class="col-span-2">
                    ปรับปรุงครั้งล่าสุดดีขึ้นแล้ว
                  </p>
                  ...
                  <p v-if="!editcomment3" class="col-span-2">
                    ที่ไปครั้งนี้ไม่ค่อยดีเท่าไหร่
                  </p>
                ...
                <o-button v-if="!showComment" @click="showComment = true"
            ...
            <div class="col-span-2">
              <div class="ml-2 flex justify-between">
                <o-button size="medium" variant="danger" @click="add = false">
                  ลบโรงแรม
                </o-button>
          ...
          <UiCard>
            ...
            <div class="w-full">
              <div class="mt-5 flex justify-between">
                <o-button variant="danger" class="ml-2">ลบไกด์</o-button>
                <o-button
                  size="medium"
                  variant="primary"
                  @click="isItemModalHotelData3 = false"
                >
                  บันทึก
                </o-button>
              </div>
        ...
        <o-modal v-model:active="isItemModalHotelData4">
          <UiCard>
            ...
            <div class="mt-5 flex justify-between">
              <o-button variant="danger" class="ml-2">ลบยานพาหนะ</o-button>
              <o-button
                size="medium"
                variant="primary"
                @click="isItemModalHotelData3 = false"
                ...
                <dev class="w-full relative inline-flex items-center">
                  <div class="mx-5">
                    ...
                    <p
                      class="text-base font-normal text-gray-500 dark:text-gray-400"
                    >
                      ที่อยู่ บ้านหนองผือ ตำบลหนองผือ อำเภอชานุมาน อำนาจเจริญ
                      37000
                    </p>
                  </div>
                </dev>
                ...
                <div class="grid grid-cols-2 gap-4">
                  ...
                  <div class="w-full">
                    <div class="flex gap-3">
                      <o-radio v-model="time" name="time" native-value="time"
                        >เวลา</o-radio
                      >
                      <o-radio
                        v-model="time"
                  ...
                  <div class="col-span-2">
                    <o-field label="หมายเหตุ">
                      <o-input
                        type="textarea"
                        modelValue="05.00 น. อ.ชานุมาน อำนาจเจริญ ออกเดินทางไปยังด่าน ตม.มุกดาหารเพื่อเดินทางต่อไปยังด่านลาวบาว"
                      ></o-input>
                    </o-field>
                  </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                  ...
                  <div class="col-span-2">
                    <o-field label="หมายเหตุ">
                      <o-input
                        type="textarea"
                        modelValue="ทานอาหารเทียง ร้านเลียจาน"
                      ></o-input>
                    </o-field>
                  </div>
                </div>
        ...
        <div class="grid grid-cols-3 gap-3">
              ...
              <div class="grid grid-cols-2 gap-2">
                <div class="p-3 border-r">
                  ...
                  >
                    ...
                    <Icon
                      class="ml-2 text-xl font-medium text-green-600 dark:text-white"
                      name="mdi:gender-male"
                    >
                    </Icon>
                  </p>
                  ...
                  <div class="flex">
                    <p
                      class="mb-2 text-base font-semibold leading-none text-gray-900 dark:text-white"
                    >
                      ข้อมูลส่วนตัว
                    </p>
                  ...
                  <div class="grid grid-cols-2">
                    <p class="mb-4 text-sm">
                      <Icon
                        class="mr-2 w-6 h-6 text-gray-600"
          ...
          <o-modal v-model:active="isItemModalAddUser">
            <UiCard>
              ...
              <div
                @click="isItemModalAddUser = false"
...
const isItemModalHotelData5 = ref(false);
const isItemModalHotelData6 = ref(false);
