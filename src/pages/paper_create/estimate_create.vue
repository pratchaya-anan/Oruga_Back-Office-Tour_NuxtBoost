        ...
        <div class="col-span-full xl:col-auto mb-4">
          <UiCard class="mb-4">
            ...
            >
              ...
              <o-field label="รายละเอียดโครงการ/กิจกรรม">
                <o-input modelValue="ค่าน้ำมันรถ"></o-input>
              </o-field>
              <o-field label="ผู้อนุมัติ (แบบอิเล็กทอรนิกส์)">
                <o-input modelValue="นายกล้วยหอม หวีน้ำหว้า"></o-input>
              </o-field>
              <section>
            ...
            >
              ...
              <div class="sm:flex xl:block xl:space-y-4">
                <div class="sm:flex-1">
                  ...
                  >
                    <div class="mt-2">ผู้ขอเคลียร์</div>
                    <div
                      class="mb-2 text-sm font-medium text-gray-900 dark:text-white"
                    >
                      ศศิศ วิรัตน์จินดา
                  ...
                  <div
                    class="text-sm not-italic font-normal text-gray-500 dark:text-gray-400"
                  >
                    <div class="mt-2">อ้างอิงถึงเลขที่ใบขอเคลียร์</div>
                    <div
                      class="mb-2 text-sm font-medium text-gray-900 dark:text-white"
                    >
                      5825-99868
                  ...
                  <div
                    class="text-sm not-italic font-normal text-gray-500 dark:text-gray-400"
                  >
                    <div class="mt-2">ผู้อนุมัติ (แบบอิเล็กทอรนิกส์)</div>
                    <div
                      class="mb-2 text-sm font-medium text-gray-900 dark:text-white"
                    >
        ...
        <div class="col-span-2">
              ...
              >
                ...
                <tbody>
                  ...
                  >
                    ...
                    <td class="px-6 py-4">WQp7985</td>
                    <td class="px-6 py-4">3885587473</td>
                    <td class="px-6 py-4">80 .-</td>
                  ...
                  >
                    ...
                    <td class="px-6 py-4">ค่ารถนำเที่ยว</td>
                    <td class="px-6 py-4">A7858575</td>
                    <td class="px-6 py-4">3885587473</td>
                    <td class="px-6 py-4">4,000 .-</td>
                    <td class="px-6 py-4 text-right">
                      <button
          ...
          <UiCard v-if="showItemsPanel">
            <div class="grid grid-cols-2 gap-4">
              ...
              <o-field class="flex-1" label="ยอดสุทธิ">
                <o-input></o-input>
              </o-field>
              <o-field label="รายการ">
                <o-select placeholder="ประเภทค่าใช้จ่าย">
                  <option value="free">ค้าน้ำแข็ง</option>
