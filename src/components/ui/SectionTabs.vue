    ...
    <ul class="flex flex-wrap -mb-px">
      ...
      <li class="mr-2">
        <a href="#"
          ...
          aria-current="page">
          <Icon class="w-5 h-5 mr-2 text-blue-600 dark:text-blue-500"
            name="mdi:view-dashboard"></Icon>
          Dashboard
        </a>
      </li>
      <li class="mr-2">
      ...
      <li class="mr-2">
        <a class="cursor-not-allowed inline-block p-4 text-gray-400 rounded-t-lg dark:text-gray-500">Disabled</a>
      </li>
    </ul>
